...
@interface YFHomeTableViewCell()
@property (nonatomic, strong) UIView * logoBorderView;
@property (nonatomic, strong) UIView *backView;

@end

@implementation YFHomeTableViewCell
...
- (void)layoutSubviews
{
    [self.backView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(kScaleW(100));
    }];
    ...
    [self.logoImage mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(kScaleW(30));
        make.width.mas_equalTo(kScaleW(30));
...
//        make.top.equalTo(self.backView.mas_top).offset(kScaleW(46));
        ...
        make.centerY.mas_equalTo(self.logoBorderView);
