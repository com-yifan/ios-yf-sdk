...
- (void)loadAndShowAd {
    [super loadAndShowAd];
    [self loadAdWithState:AdState_Normal];
//    [UIAlertController showAlertInViewController:self withTitle:@"alert" message:@"" cancelButtonTitle:@"cancel" destructiveButtonTitle:@"ok" otherButtonTitles:nil tapBlock:nil];
//
