...
typedef enum : NSUInteger {
    ...
    // KY
    YFAdFusionBannerPlatform_KY,
    // KF
    YFAdFusionBannerPlatform_KF,
    // ZD
    YFAdFusionBannerPlatform_ZD,
    // IE
    YFAdFusionBannerPlatform_IE,
    // NC
    YFAdFusionBannerPlatform_NC,
